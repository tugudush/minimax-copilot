...
export const PRICING = {
  ...
  m2_7_highspeed: { input: 0.6, output: 2.4, cacheRead: 0.06, cacheWrite: 0.375 },
} as const;

/* ---- Platform billing URL ---- */
export const BILLING_URL_CHINA = 'https://platform.minimaxi.com/user-center/basic-information/account-manage';
export const BILLING_URL_GLOBAL = 'https://platform.minimax.io/user-center/basic-information/account-manage';
